...
class QuickTest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "QuickTest")
        ...
        self.soapy_limesdr_source_0 = soapy.source(dev, "fc32", 1, 'driver=lime,antenna=LNAH',
                                  stream_args, tune_args, settings)
        self.soapy_limesdr_source_0.set_sample_rate(0, samp_rate)
        self.soapy_limesdr_source_0.set_bandwidth(0, 10e6)
        self.soapy_limesdr_source_0.set_frequency(0, 433.8e6)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(433.8e6, self.samp_rate)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(433.8e6, self.samp_rate)
        self.soapy_limesdr_source_0.set_sample_rate(0, self.samp_rate)




def main(top_block_cls=QuickTest, options=None):
